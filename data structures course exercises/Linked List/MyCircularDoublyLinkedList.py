...
class CircularDoublyLinkedList:
    ...
    def copy(self):
        ...
        while current is not None:
            ...
            if current == self.head:
                break
        return CircularDoublyLinkedList(list_copy)
    ...
    def remove_duplicates(self):
        ...
        return CircularDoublyLinkedList(unique_arr)
...
linked_list = CircularDoublyLinkedList([10, 20, 40, 40, 50, 60])
print(linked_list)
print(linked_list.length)

# linked_list1 = CircularDoublyLinkedList([10])
# print(linked_list1)
...
# linked_list3 = CircularDoublyLinkedList()
# print(linked_list3)
...
# head1 = CircularDoublyLinkedList([1,2,6,3,4,5,6])
# print(head1.remove_value(6))
# head2 = CircularDoublyLinkedList([])
# print(head2.remove_value(1))
# head3 = CircularDoublyLinkedList([7,7,7,7])
