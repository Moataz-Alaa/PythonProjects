...
class LinkedList:
    ...
    #Another way of printing the linked list to make it look like a normal list
    ...
    #     if self == reversed_list:
    #         return True
    #     else:
    #         return False
    
    #This method checks if the linked list is palindrome or not
    #ALWAYS RETURNS FALSE BECAUSE THE == OPERATOR IS LYING CAN'T BE USED MUST BE FIXED FIRST
...
linked_list = LinkedList([10, 20, 40, 40, 50, 60])
print(linked_list)
print(linked_list.length)

# linked_list1 = LinkedList([10])
# print(linked_list1)
...
# head1 = LinkedList([1,2,6,3,4,5,6])
# print(head1.remove_value(6))
# head2 = LinkedList([])
# print(head2.remove_value(1))
# head3 = LinkedList([7,7,7,7])
